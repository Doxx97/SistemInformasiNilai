...
<head>
    ...
    <title>SINILAI - Sistem Informasi Nilai SDN Liga Nusantara</title>
...
<body class="bg-gray-50 text-gray-800">
    ...
    <div class="min-h-screen flex flex-col relative overflow-hidden">
        ...
        <div class="relative z-10 container mx-auto px-4 md:px-10 flex-1 flex flex-col justify-center py-10">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-green-100 text-sm md:text-lg font-light">
                    Sistem Informasi Nilai & Akademik <br> <span class="font-semibold text-yellow-300">SDN Liga Nusantara</span>
                </p>
            </div>
        ...
        <div class="w-full mt-4 pt-4 flex justify-center items-center">
            <a href="https://link-pdf-anda.com/manual-book.pdf" target="_blank" 
            class="group inline-flex items-center border border-gray-300 gap-2 text-sm font-bold text-black-500 hover:text-[#65825C] transition-colors py-2 px-4 rounded-full hover:bg-green">
        ...
        <footer class="relative z-10 py-6 text-center text-gray-500 text-xs">
            &copy; {{ date('Y') }} SDN Liga Nusantara. All rights reserved. <br>Support by Hostinger.
        </footer>
